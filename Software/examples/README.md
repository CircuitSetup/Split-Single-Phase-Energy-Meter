...
- **HA-ESPHome_energy_meter.yaml** - Home Assistant setup config for an ESP32 running ESPHome (currently support for the energy meter is in the dev release).  The default calibration values have been loaded (9V AC Transformer, 120A/40mA CTs) [Created by digiblur](https://github.com/digiblur/digiNRG_ESPHome))
