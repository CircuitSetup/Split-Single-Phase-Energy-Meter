...
2. **Current transformers** to measure solar energy generation should be connected where the wires from the solar inverter connect to your panel. This is usually a dual pole breaker with 2 hot wires. The arrows on the CTs should be opposite eachother, like with the mains CTs. The wire that is connected to the side of the panel that is the same as the AC transformer will point towards the panel. It may take some trial an error to get this correct. 
